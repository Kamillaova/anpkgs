...
stdenv.mkDerivation {
  name = "ipw2200-fw-3.0";
  src = fetchurl {
    url = https://bughost.org/firmware/ipw2200-fw-3.0.tgz;
  ...
  meta = {
    ...
    description = "Firmware for the Intel 2200BG wireless card (requires acceptance of license, see https://ipw2200.sourceforge.net/firmware.php?fid=7";
    homepage = https://ipw2200.sourceforge.net/firmware.php;
    license = https://ipw2200.sourceforge.net/firmware.php?fid=7;
    # See also https://ipw2100.sourceforge.net/firmware_faq.php
  };
}
