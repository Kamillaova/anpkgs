...
stdenv.mkDerivation rec {
  ...
  builder = ./builder.sh;
    src = if (stdenv.system == "i686-linux") then
      fetchurl {
        url = https://ftp.task.gda.pl/pub/opera/linux/950b/final/en/i386/shared/opera-9.50b-20071024.5-shared-qt.i386-en.tar.bz2;
        sha256 = "0vv1q86is9x6vw8fx92wrnvlyn4x29zgk9zjn66rcx37n6grqqah";
      } else if (stdenv.system == "x86_64-linux") then
      fetchurl {
        url = https://ftp.task.gda.pl/pub/opera/linux/950b/final/en/x86_64/opera-9.50-20071024.2-shared-qt.x86_64-1643.tar.bz2;
