...
let { 
  body =
    stdenv.mkDerivation {
      ...
      src = fetchurl {
        url = https://abc.comlab.ox.ac.uk/dists/1.2.0/files/abc-1.2.0-src.tar.gz;
  ...
  jedd =
    stdenv.mkDerivation {
      ...
      src = fetchurl {
        url = https://abc.comlab.ox.ac.uk/dists/1.2.0/files/lib/jedd-runtime-snapshot.jar;
  ...
  javabdd =
    stdenv.mkDerivation {
      ...
      builder = ./builder-binjar.sh;
      src = fetchurl {
        url = https://abc.comlab.ox.ac.uk/dists/1.2.0/files/lib/javabdd_0.6.jar;
  ...
  paddle =
    stdenv.mkDerivation {
      ...
      builder = ./builder-binjar.sh;
      src = fetchurl {
        url = https://abc.comlab.ox.ac.uk/dists/1.2.0/files/lib/paddle-snapshot.jar;
  ...
  xact =
    stdenv.mkDerivation {
      ...
      builder = ./builder-binjar.sh;
      src = fetchurl {
        url = https://abc.comlab.ox.ac.uk/dists/1.2.0/files/lib/xact-complete-1.0-1.jar;
